...
export const AgreeModal = () => {
	...
	return (
		<div>
			{agreedStore?.agreedName !== '' && (
				<div>
					<div className='w-screen h-screen fixed bg-gray-800/80 top-0 left-0 z-10 flex'></div>
					<div
						tabIndex={-1}
						className='fixed top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0  max-h-full w-screen h-screen justify-center items-center z-11 flex'
					>
						<div className='relative w-full max-w-md max-h-full'>
							<div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
								<button
									...
									onClick={() => agreedStore.resetAgreedName()}
								>
									<svg
										aria-hidden='true'
										className='w-5 h-5'
								...
								<div className='p-6 text-center flex flex-col gap-4'>
									...
									<h3 className='text-lg font-normal text-gray-500 dark:text-gray-400'>All active members agreed on {agreedStore.agreedName}</h3>
